...
#elif KTIN_APP_VER_PATCH > 0 && KTIN_APP_VER_BUILD > 0
#define KTIN_APP_VERSION_TEXT_A \
    KTIN_STR(KTIN_APP_VER_MAJOR) "." \
    KTIN_STR(KTIN_APP_VER_MINOR) "." \
    KTIN_STR(KTIN_APP_VER_PATCH) "." \
    KTIN_STR(KTIN_APP_VER_BUILD)
#elif KTIN_APP_VER_PATCH > 0
#define KTIN_APP_VERSION_TEXT_A \
    KTIN_STR(KTIN_APP_VER_MAJOR) "." \
    KTIN_STR(KTIN_APP_VER_MINOR) "." \
    KTIN_STR(KTIN_APP_VER_PATCH)
#elif KTIN_APP_VER_BUILD > 0
#define KTIN_APP_VERSION_TEXT_A \
    KTIN_STR(KTIN_APP_VER_MAJOR) "." \
    KTIN_STR(KTIN_APP_VER_MINOR) ".0." \
    KTIN_STR(KTIN_APP_VER_BUILD)
#else
#define KTIN_APP_VERSION_TEXT_A \
    KTIN_STR(KTIN_APP_VER_MAJOR) "." \
